...
function buildOutput(skills, agents) {
    ...
    // Log activated skills for verification
    const allSkills = [...mustSkills, ...suggestSkills].map(s => s.name).join(', ');
    if (allSkills) console.error(`[ACOS] Skills activated: ${allSkills}`);
